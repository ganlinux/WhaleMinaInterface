...
//		}
	...
	public  void onHeartBeat()//发送心跳
	{
		...
		String idip = HeartBeatDataConfig.getString(context, "idip");
		boolean isOnline = HeartBeatDataConfig.getBoolean(context, "isOnline");
		String name = HeartBeatDataConfig.getString(context, "name");
		EMMSPushManager.requestHeartBeat(context,idip,isOnline,name);
	}
}
